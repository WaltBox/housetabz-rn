...
const ServiceRequestTask = ({ task, onAccept }) => {
  ...
  // Use the effective amount based on whether it's a recurring (takeOverRequest) or one-time payment
  const amount = takeOverRequest ? effectiveMonthlyAmount : effectivePaymentAmount;
